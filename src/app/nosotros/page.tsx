            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4 text-gray-600 leading-relaxed">
                  <p className="text-justify hyphens-auto" style={{ textAlignLast: "justify" }}>
                  ...
                  <p className="text-justify hyphens-auto" style={{ textAlignLast: "justify" }}>
                    Nuestro equipo se especializa en implementar digitalización de procesos, es decir, soluciones
                    capaces de llevar a su empresa al siguiente nivel. Gracias a esta iniciativa contamos con la
                    Fundación CODE100 la cual su premisa es promover la sostenibilidad de las empresas nacionales
                    reduciendo el consumo de papel.
                  </p>

                  <p className="text-justify hyphens-auto" style={{ textAlignLast: "justify" }}>
                    Somos emisores de Firma Digital hoy denominada Firma Electrónica Cualificada.
                  </p>
